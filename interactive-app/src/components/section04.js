        ...
        <div className="display-web">
            ...
            <a href="/">
              ...
              <div className="card-text">
                ...
                <div className="card-disc">
                  <p>
                    디지털아트 미술관 Visual Poetry의 몰입형 디지털 아트 조형물
                    '디지털 에테르'가 화제다.
                  </p>
                  <p>
            ...
            <a href="/">
              ...
              <div className="card-text">
                ...
                <div className="card-disc">
                  ...
                  <p>
                    빛을 통해 감각과 인식을 확장시켜 현대인들에게 새로운 예술적
                    휴식과 사색의 시간을 제공한다.
                  </p>
                </div>
              </div>
          ...
          <div className="card-item news-item">
            <a href="/">
              ...
              <div className="card-text">
                <span className="card-title">
                  '무한의 우주'를 담다…관객을 압도하는 몰입형 미디어 아트展 개막
                </span>
                <div className="card-disc">
                  <p>
                    서울의 한 갤러리에서 무한한 우주를 담아낸 듯한 몰입형 미디어
                    아트 전시가 개막해 큰 호응을 얻고 있다.
                  </p>
                  <p>
